---
title: "Model Upgrade, Important Dates, and Gateway Mediated Environmental Capabilities"
date: 2025-11-23
tags:
  - gateway
  - environment
...
At the same time, the upgrade from Qwen-2.5 7B to Qwen-2.5 14B significantly improved reasoning quality, but the larger model brought increased latency. This created the need for more deliberate visual feedback in the Magic Mirror interface.

## Work Completed
Lyra now draws from official sources via the gateway! Gateway conects to the NOAA API to determine weather conditions now and in the future. 

The gateway provides Lyra with local weather forecasts, active and scheduled alerts, high and low tide predictions from our local station. Astral provides solar and lunar data, sunrise, sunset, golden hours, tomorrow's solar timings, and moon phase.
...
![Lyra Thinking](../images/lyrathoughts.jpg){ .lyra-img }
![Lyra's Response](../images/lyraanswer.jpg){ .lyra-img }
